...
/**
 * The container that holds OpenGL matrix.
 * Contains the GL matrix on top of the tranformation matrixes.
 */
class Object3DGL : public Object3D {
protected:
    kk3d::math::Matrix4x4 _mat_gl;                  /**< The matrix used in OpenGL */
...
public:
    ...
    /**
     * Get the pointer to the OpenGL matrix.
